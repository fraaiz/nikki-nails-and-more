    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
        <div class="flex flex-col pt-4">
            <div class="-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
                <form action="{{ route('admin::treatments.remove', [$treatment]) }}" method="POST">
                    @csrf
                    ...
                    <div class="mt-6 w-1/2">
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-1 rounded-md shadow-sm">
                                <input id="name" name="name" class="form-input block w-full transition duration-150 ease-in-out sm:text-sm sm:leading-5" placeholder="Enter treatment name here..." type="text" value="{{ old('name', $treatment->name) }}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-6 w-1/2">
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-1 rounded-md shadow-sm">
                                <input id="page_url" name="page_url" class="form-input block w-full transition duration-150 ease-in-out sm:text-sm sm:leading-5" placeholder="Enter page URL here..." type="text" value="{{ old('page_url', $treatment->page_url) }}">
