            ...
            <div class="grid grid-cols-2 gap-8 xl:col-span-2">
                <div class="md:grid md:grid-cols-2 md:gap-8">
                    <div>
                        ...
                        <ul class="mt-4 space-y-4">
                            <li>
                                <a href="/behandelingen/pedicure" class="text-base leading-6 text-gray-500 hover:text-gray-900">
                                    Pedicure
                                </a>
                            </li>
                            <li>
                                <a href="/behandelingen/manicure" class="text-base leading-6 text-gray-500 hover:text-gray-900">
                                    Manicure                                </a>
                            </li>
                            <li>
                                <a href="/behandelingen/gelcolor" class="text-base leading-6 text-gray-500 hover:text-gray-900">
                                    Gelcolor                                </a>
                            </li>
                            <li>
                                <a href="/behandelingen/gezicht" class="text-base leading-6 text-gray-500 hover:text-gray-900">
                                    Gezicht                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="md:grid md:grid-cols-2 md:gap-8">
                    <div>
                        ...
                        <ul class="mt-4 space-y-4">
                            <li>
                                <a href="/prijslijst" class="text-base leading-6 text-gray-500 hover:text-gray-900">
                                    Prijslijst
                                </a>
                            </li>
                            <li>
...
{{--                    </div>--}}
        ...
        <div class="mt-8 border-t border-gray-200 pt-8 md:flex md:items-center md:justify-between">
            <div class="flex space-x-6 md:order-2">
                <a href="https://www.facebook.com/nikkinailsandmore" class="text-gray-400 hover:text-gray-500">
                    <span class="sr-only">Facebook</span>
                    <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                        <path fill-rule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clip-rule="evenodd" />
                    </svg>
                </a>
                <a href="https://www.instagram.com/nikkinailsandmore/" class="text-gray-400 hover:text-gray-500">
            ...
            <p class="mt-8 text-base leading-6 text-gray-400 md:mt-0 md:order-1">
                &copy; {{ now()->year }} {{ config('app.name') }}. Gerealiseerd door <a href="mailto:jessemartinbrouwer@gmail.com">Jesse Brouwer</a>.
            </p>
        </div>
    </div>
</footer>
