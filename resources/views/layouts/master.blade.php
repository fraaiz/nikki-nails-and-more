...
<style>
    body {
        background-image: url("{{ asset('media/achtergrondwebsite.jpg') }}");
    }
</style>
        ...
        <div>
            ...
            <div class="center pt-8 pb-4">
                ...
                <div class=" center grid grid-flow-col w-64 mb-2 sm:-mx-1 md:-mx-px lg:-mx-2 xl:  ">
                    ...
                    <A href="https://www.instagram.com/nikkinailsandmore/"
                       class="overflow-hidden sm:my-1 sm:px-1 sm:w-1/2 md:my-px md:px-px md:w-1/2 lg:my-2 lg:px-2 lg:w-1/4  xl:px-2 xl:w-auto fa fa-instagram"></A>
                    <A href="https://www.facebook.com/nikkinailsandmore"
                       class="overflow-hidden sm:my-1 sm:px-1 sm:w-1/2 md:my-px md:px-px md:w-1/2 lg:my-2 lg:px-2 lg:w-1/4  xl:px-2 xl:w-auto fa fa-facebook"></A>
            ...
            <div class="pt-4 md:flex md:items-center md:justify-center "
                ...
                <ul class="">
                    ...
                    <li class="md:mx-2 md:inline leading-7 text-sm" id="footer-navi-2">
                        <a class="text-white underline text-small" href="/404">
                            Disclaimer
                        </a>
                    </li>
                    <li class="md:mx-2 md:inline leading-7 text-sm" id="footer-navi-2">
                    ...
                    <li class="md:mx-2 md:inline leading-7 text-sm" id="footer-navi-2"><a
                            class="text-white underline text-small" href="/404">Privacy</a></li>
                </ul>
            </div>
        </div>
    </nav>
