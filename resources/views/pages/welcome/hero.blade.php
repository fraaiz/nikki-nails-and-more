    ...
    <div class="container md:flex relative mx-auto px-4">
        <div class="hidden md:block flex-none pr-5">
            <div class="flex items-center h-full">
                {{--    User photo    --}}
                <img src="{{ asset('media/images/nikki.png') }}" class="md:w-64 rounded-full" />
            </div>
        </div>
        <div class="flex-auto pl-5">
            ...
            <button class="mt-8 bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow">
                Afspraak maken
            </button>
        </div>
    </div>
